...
class LinkedList:
    ...
    def sort(self):
        """Сортировка списка с использованием алгоритма сортировки вставками."""
        if not self.head:
            return
    ...
    def create_sorted_list(self):
        """Создание нового списка L2 с элементами списка L1, отсортированными по возрастанию."""
        sorted_list = LinkedList()
        current = self.head

        while current:
            sorted_list.insert_at_end(current.data)
...
if __name__ == "__main__":
    ...
    sorted_list = linked_list.create_sorted_list()

    print("Отсортированный список L2:")
    sorted_list.display()
...
linked_list.delete_from_position(1)
